  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "We provide digital marketing including AI-Ready SEO, website development, and email campaigns — all engineered to make your business visible across the new landscape of AI-powered search and traditional search engines.",
      },
    },
    {
      "@type": "Question",
